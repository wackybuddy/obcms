...
class DeprecatedURLRedirectMiddleware:
    ...
    URL_MAPPING = {
        ...
        'common:communities_edit': 'communities:edit',
        'common:communities_delete': 'communities:delete',
        'common:communities_restore': 'communities:restore',
        'common:communities_manage': 'communities:manage',
        'common:communities_manage_municipal': 'communities:manage_municipal',
        'common:communities_manage_barangay_obc': 'communities:manage_barangay_obc',
        'common:communities_manage_municipal_obc': 'communities:manage_municipal_obc',
        'common:communities_manage_provincial': 'communities:manage_provincial',
        'common:communities_manage_provincial_obc': 'communities:manage_provincial_obc',
        'common:communities_view_municipal': 'communities:view_municipal',
        'common:communities_edit_municipal': 'communities:edit_municipal',
        'common:communities_delete_municipal': 'communities:delete_municipal',
        'common:communities_restore_municipal': 'communities:restore_municipal',
        'common:communities_view_provincial': 'communities:view_provincial',
        'common:communities_edit_provincial': 'communities:edit_provincial',
        'common:communities_delete_provincial': 'communities:delete_provincial',
        'common:communities_submit_provincial': 'communities:submit_provincial',
        'common:communities_restore_provincial': 'communities:restore_provincial',
        'common:communities_stakeholders': 'communities:stakeholders',

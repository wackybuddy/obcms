...
urlpatterns = [
    ...
    path('coordination/organizations/add/', views.coordination_organizations, name='coordination_organization_add'),
    path('coordination/partnerships/', views.coordination_partnerships, name='coordination_partnerships'),
    path('coordination/partnerships/add/', views.coordination_partnerships, name='coordination_partnership_add'),

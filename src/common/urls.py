...
urlpatterns = [
    ...
    path('communities/managebarangayobc/', views.communities_manage_barangay_obc, name='communities_manage_barangay_obc'),
    path('communities/managemunicipalobc/', views.communities_manage_municipal_obc, name='communities_manage_municipal_obc'),

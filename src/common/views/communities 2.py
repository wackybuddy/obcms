...
def _build_barangay_table(communities_page, *, can_manage: bool) -> dict:
    ...
    headers = [
        {"label": "Barangay", "class": "flex-1 min-w-[180px] items-center"},
        {"label": "Location", "class": "flex-1 min-w-[200px] items-center"},
        {"label": "Coverage Snapshot", "class": "flex-1 min-w-[240px] items-center"},
    ]
    ...
    for community in communities_page:
        ...
        if province:
            location_parts.append(
                format_html("<div class='text-sm text-gray-700'>{}</div>", province.name)
            )
        if region:
            location_parts.append(
                format_html(
        ...
        rows.append(
            {
                "cells": [
                    {"content": barangay_html, "class": "flex-1 min-w-[180px] items-center"},
                    {"content": location_html, "class": "flex-1 min-w-[200px] items-center"},
                    {"content": snapshot_html, "class": "flex-1 min-w-[240px] items-center"},
                ],
...
def communities_manage_municipal(request):
    ...
    municipality_table_headers = [
        {"label": "Municipality/City", "class": "flex-1 min-w-[180px] items-center"},
        {"label": "Province & Region", "class": "flex-1 min-w-[150px] items-center"},
        {"label": "Coverage Snapshot", "class": "flex-1 min-w-[200px] items-center"},
        {"label": "Top 5 Barangays", "class": "flex-1 min-w-[220px] items-center"},
        {"label": "Sync Mode", "class": "flex-none w-32 items-center"},
    ]
    ...
    for coverage in coverages_page:
        ...
        row = {
            "cells": [
                {"content": municipality_html, "class": "flex-1 min-w-[180px] items-center"},
                {"content": province_html, "class": "flex-1 min-w-[150px] items-center"},
                {"content": snapshot_html, "class": "flex-1 min-w-[200px] items-center"},
                {"content": key_barangays_html, "class": "flex-1 min-w-[220px] items-center"},
                {"content": sync_html, "class": "flex-none w-32 items-center"},
            ],
            "view_url": view_url,
        }
        if edit_url:
...
def communities_manage_provincial(request):
    ...
    province_table_headers = [
        ...
        {"label": "Coverage Snapshot", "class": "flex-1 min-w-[200px] items-center"},
        {"label": "Top 5 Municipalities/Cities", "class": "flex-1 min-w-[240px] items-center"},
        {"label": "Sync Mode", "class": "flex-none w-32 items-center"},
    ]
    ...
    for coverage in coverages_page:
        ...
        row = {
            "cells": [
                ...
                {"content": snapshot_html, "class": "flex-1 min-w-[200px] items-center"},
                {"content": key_municipalities_html, "class": "flex-1 min-w-[240px] items-center"},
                {"content": sync_mode_html, "class": "flex-none w-32 items-center"},
            ],
            "view_url": view_url,
        }

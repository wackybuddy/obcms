...
class CustomGroupChangeList:
    ...
    def __init__(self, request, model, list_display, list_display_links, 
        ...
        self.previous_page_number = self.page_obj.previous_page_number() if self.has_previous else None
        self.next_page_number = self.page_obj.next_page_number() if self.has_next else None
        ...
        if self.result_count > 0:
            ...
            self.end_index = min(self.start_index + self.list_per_page - 1, self.result_count)
        else:
            self.start_index = 0
            self.end_index = 0

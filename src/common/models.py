...
class User(AbstractUser):
    ...
    approved_at = models.DateTimeField(
        null=True,
        blank=True,
        help_text="When the account was approved"
    )
...
class Region(models.Model):
    ...
    description = models.TextField(
        blank=True,
        help_text="Additional region description or notes"
    )
...
class Province(models.Model):
    ...
    code = models.CharField(
        max_length=10, 
        unique=True,
        help_text="Official province code"
    )
    name = models.CharField(
        max_length=255,
        help_text="Official province name"
    )
    capital = models.CharField(
        max_length=255,
        blank=True,
        help_text="Provincial capital city"
    )
    is_active = models.BooleanField(
        default=True,
...
class Municipality(models.Model):
    ...
    name = models.CharField(
        max_length=255,
        help_text="Official municipality/city name"
    )
    ...
    def full_path(self):
        """Return the full administrative path."""
        return f"Region {self.province.region.code} > {self.province.name} > {self.name}"
...
class Barangay(models.Model):
    ...
    code = models.CharField(
        max_length=10, 
        unique=True,
        help_text="Official barangay code"
    )
    name = models.CharField(
        max_length=255,
        help_text="Official barangay name"
    )
    ...
    def full_path(self):
        """Return the full administrative path."""
        return (f"Region {self.municipality.province.region.code} > "

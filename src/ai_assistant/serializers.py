...
class AIConversationSerializer(serializers.ModelSerializer):
    ...
    related_policy_title = serializers.CharField(source='related_policy.title', read_only=True)
    ...
    class Meta:
        ...
        fields = [
            'id', 'user', 'user_name', 'conversation_type', 'title',
            'related_policy', 'related_policy_title', 'messages', 'context_data',
            'model_used', 'is_active', 'message_count', 'last_message_time',
...
class AIConversationCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = AIConversation
        fields = [
            'conversation_type', 'title', 'related_policy', 'context_data'
        ]
...
class AIInsightSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = AIInsight
        fields = [
            'id', 'title', 'insight_type', 'content', 'summary',
            'related_policy', 'related_policy_title', 'conversation',
            'model_used', 'confidence_level', 'key_points', 'recommendations',
            'cultural_considerations', 'is_validated', 'validated_by',
            'validated_by_name', 'validation_notes', 'view_count',
            'usefulness_score', 'generated_by', 'generated_by_name',
            'tags', 'created_at', 'updated_at'
        ]
        read_only_fields = [
            'id', 'view_count', 'generated_by', 'created_at', 'updated_at'
        ]
...
class AIGeneratedDocumentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'title', 'document_type', 'content', 'related_policy',
            'related_policy_title', 'conversation', 'prompt_used', 'model_used',
            'generation_parameters', 'sections', 'key_points', 'status',
            'reviewed_by', 'reviewed_by_name', 'review_notes', 'pdf_file',
            'word_file', 'generated_by', 'generated_by_name', 'download_count',
            'created_at', 'updated_at'
        ]
        read_only_fields = [
            'id', 'download_count', 'generated_by', 'created_at', 'updated_at'
        ]
...
class AIInsightCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = AIInsight
        fields = [
            'title', 'insight_type', 'content', 'summary', 'related_policy',
            'conversation', 'confidence_level', 'key_points', 'recommendations',
            'cultural_considerations', 'tags'
        ]
...
class AIUsageMetricsSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'user', 'user_name', 'date', 'conversations_started',
            'messages_sent', 'insights_generated', 'documents_created',
            'policy_analysis_used', 'document_generation_used',
            'cultural_guidance_used', 'evidence_review_used',
            'average_response_time', 'total_tokens_used', 'created_at'
        ]

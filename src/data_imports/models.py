...
class DataImport(models.Model):
    ...
    title = models.CharField(
        max_length=255,
        help_text="Descriptive title for this import"
    )
    
    description = models.TextField(
        blank=True,
        help_text="Detailed description of the import"
    )
    ...
    processing_log = models.TextField(
        blank=True,
        help_text="Processing log with detailed information"
    )
...
class ImportLog(models.Model):
    ...
    exception_details = models.TextField(
        blank=True,
        help_text="Detailed exception information"
    )
...
class FieldMapping(models.Model):
    ...
    description = models.TextField(
        blank=True,
        help_text="Description of this mapping"
    )
...
class ImportTemplate(models.Model):
    ...
    description = models.TextField(
        blank=True,
        help_text="Template description and instructions"
    )
    ...
    validation_rules = models.JSONField(
        default=dict,
        help_text="Validation rules for fields"
    )

...
from .models import DataImport, FieldMapping, ImportLog, ImportTemplate
...
class DataImportAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("File Information", {"fields": ("file", "file_size")}),
        (
            "Settings",
            {"fields": ("mapping", "import_options"), "classes": ("collapse",)},
        ),
        (
            "Progress",
            {
        ...
        ("Logs", {"fields": ("processing_log", "error_log"), "classes": ("collapse",)}),
        (
            "Metadata",
...
class FieldMappingAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("name", "import_type", "description", "is_default")}),
        ("Mapping Configuration", {"fields": ("mapping",)}),
        (
            "Metadata",
            {
...
class ImportTemplateAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("name", "import_type", "description", "is_active")}),
        ("Template File", {"fields": ("template_file",)}),
        (
            "Field Configuration",
            {
        ...
        ("Validation", {"fields": ("validation_rules",), "classes": ("collapse",)}),
        (
            "Metadata",
            {
                "fields": ("created_by", "created_at", "updated_at"),

...
class AssessmentCategory(models.Model):
    ...
    description = models.TextField(
        blank=True,
        help_text="Description of the assessment category"
    )
...
class Assessment(models.Model):
    ...
    title = models.CharField(
        max_length=200,
        help_text="Title of the assessment"
    )
    ...
    secondary_methodologies = models.JSONField(
        null=True,
        blank=True,
        help_text="List of secondary methodologies used"
    )
    ...
    key_findings = models.TextField(
        blank=True,
        help_text="Key findings from the assessment"
    )
    ...
    def clean(self):
        if self.planned_end_date and self.planned_start_date:
            if self.planned_end_date < self.planned_start_date:
                raise ValidationError("Planned end date cannot be earlier than start date")
        
        if self.actual_end_date and self.actual_start_date:
            if self.actual_end_date < self.actual_start_date:
                raise ValidationError("Actual end date cannot be earlier than start date")
...
class Survey(models.Model):
    ...
    description = models.TextField(
        help_text="Description of the survey"
    )
    ...
    target_respondents = models.IntegerField(
        help_text="Target number of respondents"
    )
    
    actual_respondents = models.IntegerField(
        default=0,
        help_text="Actual number of respondents"
    )
    
    # Timeline
    start_date = models.DateField(
        help_text="Survey start date"
    )
    
    end_date = models.DateField(
        help_text="Survey end date"
    )
    
    # Survey Configuration
    questions_count = models.IntegerField(
        default=0,
        help_text="Number of questions in the survey"
    )
...
class SurveyResponse(models.Model):
    ...
    responses = models.JSONField(
        help_text="Survey responses (JSON format)"
    )
...
class MappingActivity(models.Model):
    ...
    title = models.CharField(
        max_length=150,
        help_text="Title of the mapping activity"
    )
    ...
    description = models.TextField(
        help_text="Description of the mapping activity"
    )
    ...
    # Timeline
    start_date = models.DateField(
        help_text="Start date of mapping activity"
    )
    
    end_date = models.DateField(
        help_text="End date of mapping activity"
    )
    ...
    methodology = models.TextField(
        help_text="Methodology used for mapping"
    )
    
    tools_used = models.TextField(
        blank=True,
        help_text="Tools and equipment used for mapping"
    )
    
    # Results
    findings = models.TextField(
        blank=True,
        help_text="Key findings from the mapping activity"
    )
...
class NeedsCategory(models.Model):
    ...
    description = models.TextField(
        help_text="Description of this needs category"
    )
...
class Need(models.Model):
    ...
    title = models.CharField(
        max_length=200,
        help_text="Title/name of the identified need"
    )
    ...
    affected_households = models.IntegerField(
        null=True,
        blank=True,
        help_text="Number of households affected"
    )
    
    geographic_scope = models.TextField(
        help_text="Geographic scope/area affected"
    )
    ...
    evidence_sources = models.TextField(
        help_text="Sources of evidence for this need"
    )
    ...
    is_validated = models.BooleanField(
        default=False,
        help_text="Whether this need has been validated"
    )
    ...
    validation_date = models.DateTimeField(
        null=True,
        blank=True,
        help_text="Date when need was validated"
    )
    ...
    def calculate_priority_score(self):
        ...
        base_score = (urgency_weight + impact_weight + feasibility_weight + population_factor) / 4
...
class NeedsPrioritization(models.Model):
    ...
    title = models.CharField(
        max_length=200,
        help_text="Title of the prioritization exercise"
    )
    ...
    # Timeline
    start_date = models.DateField(
        help_text="Start date of prioritization exercise"
    )
    
    end_date = models.DateField(
        help_text="End date of prioritization exercise"
    )
    ...
    top_priorities = models.TextField(
        blank=True,
        help_text="Summary of top priority needs identified"
    )
    
    recommendations = models.TextField(
        blank=True,
        help_text="Recommendations based on prioritization"
    )
...
class NeedsPrioritizationItem(models.Model):
    ...
    justification = models.TextField(
        blank=True,
        help_text="Justification for the ranking/scoring"
    )
...
class GeographicDataLayer(models.Model):
    ...
    name = models.CharField(
        max_length=150,
        help_text="Name of the geographic data layer"
    )
    ...
    zoom_level_min = models.IntegerField(
        default=1,
        help_text="Minimum zoom level for layer visibility"
    )
    
    zoom_level_max = models.IntegerField(
        default=18,
        help_text="Maximum zoom level for layer visibility"
    )
    ...
    accuracy_meters = models.FloatField(
        null=True,
        blank=True,
        help_text="Estimated accuracy in meters"
    )
    ...
    attribution = models.TextField(
        blank=True,
        help_text="Data attribution and source credits"
    )
    ...
    feature_count = models.IntegerField(
        default=0,
        help_text="Number of features in the layer"
    )
...
class MapVisualization(models.Model):
    ...
    title = models.CharField(
        max_length=200,
        help_text="Title of the map visualization"
    )
    ...
    legend_configuration = models.JSONField(
        null=True,
        blank=True,
        help_text="Legend display configuration"
    )
    
    popup_template = models.TextField(
        blank=True,
        help_text="HTML template for feature popups"
    )
    ...
    enable_clustering = models.BooleanField(
        default=False,
        help_text="Whether to enable point clustering"
    )
    
    enable_search = models.BooleanField(
        default=False,
        help_text="Whether to enable location search"
    )
    
    enable_drawing = models.BooleanField(
        default=False,
        help_text="Whether to enable drawing tools"
    )
...
class SpatialDataPoint(models.Model):
    ...
    name = models.CharField(
        max_length=200,
        help_text="Name or identifier of the point"
    )
    
    description = models.TextField(
        blank=True,
        help_text="Description of the point"
    )
    ...
    is_verified = models.BooleanField(
        default=False,
        help_text="Whether this point has been verified"
    )
    ...
    verification_date = models.DateTimeField(
        null=True,
        blank=True,
        help_text="Date when point was verified"
    )
    
    # Photo and Media
    photo_url = models.URLField(
        blank=True,
        help_text="URL to photo of the location"
    )
...
class BaselineStudy(models.Model):
    ...
    title = models.CharField(
        max_length=250,
        help_text="Title of the baseline study"
    )
    ...
    description = models.TextField(
        help_text="Detailed description of the study"
    )
    ...
    # Timeline
    planned_start_date = models.DateField(
        help_text="Planned start date for the study"
    )
    ...
    sample_size_actual = models.IntegerField(
        default=0,
        help_text="Actual sample size achieved"
    )
    ...
    geographic_coverage = models.TextField(
        help_text="Geographic coverage of the study"
    )
    
    target_population = models.TextField(
        help_text="Description of target population"
    )
    ...
    recommendations = models.TextField(
        blank=True,
        help_text="Study recommendations"
    )
    
    limitations = models.TextField(
        blank=True,
        help_text="Study limitations and constraints"
    )
    ...
    study_protocol = models.TextField(
        blank=True,
        help_text="Study protocol and procedures"
    )
    
    data_analysis_plan = models.TextField(
        blank=True,
        help_text="Data analysis plan and methods"
    )
    
    # Ethical Considerations
    ethics_approval = models.BooleanField(
        default=False,
        help_text="Whether ethics approval was obtained"
    )
    ...
    consent_procedures = models.TextField(
        blank=True,
        help_text="Informed consent procedures"
    )
...
class BaselineStudyTeamMember(models.Model):
    ...
    responsibilities = models.TextField(
        blank=True,
        help_text="Specific responsibilities and tasks"
    )
...
class BaselineDataCollection(models.Model):
    ...
    planned_date = models.DateField(
        help_text="Planned date for data collection"
    )
    ...
    data_collected = models.JSONField(
        null=True,
        blank=True,
        help_text="Collected data (JSON format)"
    )
    
    data_quality_notes = models.TextField(
        blank=True,
        help_text="Notes on data quality and issues"
    )
    ...
    is_validated = models.BooleanField(
        default=False,
        help_text="Whether the data has been validated"
    )
    ...
    validation_date = models.DateTimeField(
        null=True,
        blank=True,
        help_text="Date when data was validated"
    )
    
    validation_notes = models.TextField(
        blank=True,
        help_text="Validation notes and feedback"
    )
...
class BaselineIndicator(models.Model):
    ...
    baseline_value = models.TextField(
        help_text="Baseline value of the indicator"
    )
    ...
    data_source = models.CharField(
        max_length=100,
        help_text="Source of data for this indicator"
    )
    ...
    data_quality_notes = models.TextField(
        blank=True,
        help_text="Notes on data quality and reliability"
    )
...
class CommunityChallenges(models.Model):
    ...
    title = models.CharField(
        max_length=200,
        help_text="Brief title of the challenge"
    )
    ...
    support_needed = models.TextField(
        blank=True,
        help_text="Support needed to address this challenge"
    )
...
class CommunityAspirations(models.Model):
    ...
    title = models.CharField(
        max_length=200,
        help_text="Brief title of the aspiration"
    )
    ...
    potential_partners = models.TextField(
        blank=True,
        help_text="Potential partners for implementation"
    )

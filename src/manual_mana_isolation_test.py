...
def run_manual_test() -> int:
    """Execute the manual isolation smoke test with explicit output."""
    os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'obc_management.settings')

    # Import Django lazily so pytest collection does not trigger database access.
    import django

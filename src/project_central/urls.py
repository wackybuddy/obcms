...
urlpatterns = [
    ...
    path('projects/<uuid:workflow_id>/edit/', views.edit_project_workflow, name='edit_project_workflow'),
    ...
    path('reports/budget/generate/', views.generate_budget_execution_report, name='generate_budget_execution_report'),
    ...
    path('tasks/generate/<uuid:workflow_id>/', views.generate_workflow_tasks, name='generate_workflow_tasks'),

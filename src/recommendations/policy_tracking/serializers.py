...
class PolicyRecommendationSerializer(serializers.ModelSerializer):
    ...
    related_need_title = serializers.CharField(
        source="related_need.title", read_only=True
    )
    ...
    policy_category_display = serializers.CharField(
        source="get_policy_category_display", read_only=True
    )

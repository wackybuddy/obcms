...
class StakeholderEngagementSerializer(serializers.ModelSerializer):
    ...
    engagement_type_name = serializers.CharField(source='engagement_type.name', read_only=True)
    community_name = serializers.CharField(source='community.name', read_only=True)
    lead_facilitator_name = serializers.CharField(source='lead_facilitator.get_full_name', read_only=True)
...
class EventListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Event
        fields = [
            'id', 'title', 'event_type', 'community_name', 'organizer_name',
            'planned_date', 'actual_date', 'status', 'participant_count',
            'action_item_count', 'is_virtual', 'virtual_platform'
        ]
...
class PartnershipMilestoneSerializer(serializers.ModelSerializer):
    ...
    partnership_title = serializers.CharField(source='partnership.title', read_only=True)
...
class PartnershipSerializer(serializers.ModelSerializer):
    ...
    lead_organization_name = serializers.CharField(source='lead_organization.name', read_only=True)
...
class PartnershipListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Partnership
        fields = [
            'id', 'title', 'partnership_type', 'lead_organization_name',
            'status', 'start_date', 'end_date', 'signatory_count',
            'milestone_count', 'is_active'
        ]

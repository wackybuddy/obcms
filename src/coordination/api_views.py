...
from .models import (
    ...
    ConsultationFeedback, EngagementTracking, Organization, OrganizationContact,
    Communication, CommunicationTemplate, CommunicationSchedule,
    Event, EventParticipant, ActionItem, EventDocument,
    Partnership, PartnershipSignatory, PartnershipMilestone, PartnershipDocument
)
from .serializers import (
    StakeholderEngagementTypeSerializer, StakeholderEngagementSerializer,
    EngagementFacilitatorSerializer, ConsultationFeedbackSerializer,
    EngagementTrackingSerializer, OrganizationSerializer, OrganizationContactSerializer,
    CommunicationSerializer, CommunicationTemplateSerializer, CommunicationScheduleSerializer,
    EventSerializer, EventListSerializer, EventParticipantSerializer,
    ActionItemSerializer, EventDocumentSerializer, PartnershipSerializer,
    PartnershipListSerializer, PartnershipSignatorySerializer,
    PartnershipMilestoneSerializer, PartnershipDocumentSerializer
)
...
class EventParticipantViewSet(viewsets.ModelViewSet):
    ...
    permission_classes = [permissions.IsAuthenticated]
    filter_backends = [DjangoFilterBackend, filters.SearchFilter, filters.OrderingFilter]
    filterset_fields = ['event', 'response_status', 'attendance_status', 'participant_type']
...
class PartnershipSignatoryViewSet(viewsets.ModelViewSet):
    ...
    queryset = PartnershipSignatory.objects.all().select_related('partnership', 'organization')

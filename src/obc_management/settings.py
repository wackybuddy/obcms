...
RUNTIME_ROOT = BASE_DIR.parent / "var"
...
DATABASES = {"default": env.db(default="sqlite:///" + str((RUNTIME_ROOT / "db.sqlite3").resolve()))}
...
LOGGING = {
    ...
    "handlers": {
        "file": {
            ...
            "filename": RUNTIME_ROOT / "logs" / "django.log",
            "formatter": "verbose",
        },
        "console": {
            "level": "INFO",
...
os.makedirs(RUNTIME_ROOT / "logs", exist_ok=True)

...
class GeographicDataLayerForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'geojson_data': forms.Textarea(attrs={
            ...
            'bounding_box': forms.Textarea(attrs={
                'class': 'block w-full rounded-lg border-gray-300 shadow-sm focus:ring-purple-500 focus:border-purple-500 font-mono text-sm',
                'rows': 2,
                'placeholder': '[min_lng, min_lat, max_lng, max_lat]'
            }),
            'center_point': forms.Textarea(attrs={
                'class': 'block w-full rounded-lg border-gray-300 shadow-sm focus:ring-purple-500 focus:border-purple-500 font-mono text-sm',
                'rows': 2,
                'placeholder': '[longitude, latitude]'
            }),
            'style_properties': forms.Textarea(attrs={
                'class': 'block w-full rounded-lg border-gray-300 shadow-sm focus:ring-purple-500 focus:border-purple-500 font-mono text-sm',
                'rows': 4,
                'placeholder': 'JSON styling properties (colors, symbols, etc.)'
            }),
            'zoom_level_min': forms.NumberInput(attrs={
                'class': 'block w-full rounded-lg border-gray-300 shadow-sm focus:ring-purple-500 focus:border-purple-500',
                'min': 1,
                'max': 18
            }),
            'zoom_level_max': forms.NumberInput(attrs={
                'class': 'block w-full rounded-lg border-gray-300 shadow-sm focus:ring-purple-500 focus:border-purple-500',
                'min': 1,
                'max': 18
            }),
            ...
            'data_collection_date': forms.DateInput(attrs={
                'class': 'block w-full rounded-lg border-gray-300 shadow-sm focus:ring-purple-500 focus:border-purple-500',
                'type': 'date'
            }),
            'accuracy_meters': forms.NumberInput(attrs={
                'class': 'block w-full rounded-lg border-gray-300 shadow-sm focus:ring-purple-500 focus:border-purple-500',
                'step': 0.1
            }),
            ...
            'attribution': forms.Textarea(attrs={
                'class': 'block w-full rounded-lg border-gray-300 shadow-sm focus:ring-purple-500 focus:border-purple-500',
                'rows': 3,
                'placeholder': 'Data attribution and source credits'
            }),
            'license_info': forms.TextInput(attrs={
                'class': 'block w-full rounded-lg border-gray-300 shadow-sm focus:ring-purple-500 focus:border-purple-500',
            ...
            'access_groups': forms.Textarea(attrs={
                'class': 'block w-full rounded-lg border-gray-300 shadow-sm focus:ring-purple-500 focus:border-purple-500 font-mono text-sm',
                'rows': 3,
...
class MapVisualizationForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'visualization_type': forms.Select(attrs={
                'class': 'block w-full rounded-lg border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500'
            }),
            'community': forms.Select(attrs={
                'class': 'block w-full rounded-lg border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500'
            ...
            'basemap_provider': forms.Select(attrs={
                'class': 'block w-full rounded-lg border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500'
            }),
            'initial_zoom': forms.NumberInput(attrs={
                'class': 'block w-full rounded-lg border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500',
                'min': 1,
                'max': 18
            }),
            'initial_center': forms.Textarea(attrs={
            ...
            'legend_configuration': forms.Textarea(attrs={
                'class': 'block w-full rounded-lg border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500 font-mono text-sm',
                'rows': 4,
                'placeholder': 'JSON legend display configuration'
            }),
            'popup_template': forms.Textarea(attrs={
                'class': 'block w-full rounded-lg border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500 font-mono text-sm',
                'rows': 6,
                'placeholder': 'HTML template for feature popups'
            }),
            'filters_configuration': forms.Textarea(attrs={
                'class': 'block w-full rounded-lg border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500 font-mono text-sm',
                'rows': 4,
                'placeholder': 'JSON interactive filters configuration'
            }),
            'is_interactive': forms.CheckboxInput(attrs={
                'class': 'rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50'
            }),
            'enable_clustering': forms.CheckboxInput(attrs={
                'class': 'rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50'
            }),
            'enable_search': forms.CheckboxInput(attrs={
                'class': 'rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50'
            }),
            'enable_drawing': forms.CheckboxInput(attrs={
                'class': 'rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50'
            }),
            'is_public': forms.CheckboxInput(attrs={
                'class': 'rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50'
            }),
            'is_embedded': forms.CheckboxInput(attrs={
                'class': 'rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50'
            }),
            'layers': forms.CheckboxSelectMultiple(attrs={
                'class': 'space-y-2'
            }),
        }
